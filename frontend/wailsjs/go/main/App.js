...
export function GenerateXrayConfig(arg1) {
  return window['go']['main']['App']['GenerateXrayConfig'](arg1);
}
...
export function GetXrayNodes() {
  return window['go']['main']['App']['GetXrayNodes']();
}
