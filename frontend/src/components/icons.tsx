...
export const SketchySpinner = ({ className, style }: IconProps) => (
  <svg className={cn(className, "animate-spin")} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21 12a9 9 0 1 1-6.219-8.56" />
  </svg>
);

export const SketchyX = ({ className, style }: IconProps) => (
...
export const SketchyStar = ({ className, style }: IconProps) => (
...
export const SketchyGear = ({ className, style }: IconProps) => (
...
export const SketchyTerminal = ({ className, style }: IconProps) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export const SketchyCheck = ({ className, style }: IconProps) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
