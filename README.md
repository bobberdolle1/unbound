...
Цензура процветает в тишине. Каждый раз, когда государство, провайдер или корпорация решают, что вы можете, а что не можете, они блокируют не просто сайты — они блокируют **идеи**, **инновации** и **человеческие связи**.
