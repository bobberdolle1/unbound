...
[![Version](https://img.shields.io/badge/Version-v0.3.1-08090b?style=for-the-badge&logo=rocket)](#)
...
# 3. Сборка CLI-версии
go build -trimpath -ldflags="-s -w -X unbound/engine.Version=0.3.1" -o build/bin/unbound .
# 4. Сборка Wails GUI
wails build -clean -ldflags "-X unbound/engine.Version=0.3.1"
