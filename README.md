...
[![Version](https://img.shields.io/badge/Version-v0.6.4-08090b?style=for-the-badge&logo=rocket)](#)
...
- **Модель возможностей & AutoTune v3**: учёт системных требований стратегий (наличие TCP timestamps, входящий перехват, QUIC) с пропуском несовместимых вариантов и обоснованием выбора победителя.
...
go build -trimpath -ldflags="-s -w -X unbound/engine.Version=0.6.4" -o build/bin/unbound .
# 4. Сборка Wails GUI
wails build -clean -ldflags "-X unbound/engine.Version=0.6.4"
---
