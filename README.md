...
[![Version](https://img.shields.io/badge/Version-v0.6.2-08090b?style=for-the-badge&logo=rocket)](#)
...
go build -trimpath -ldflags="-s -w -X unbound/engine.Version=0.6.2" -o build/bin/unbound .
# 4. Сборка Wails GUI
wails build -clean -ldflags "-X unbound/engine.Version=0.6.2"
---
